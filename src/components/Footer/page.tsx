...
function Footer() {
  return (
    <footer className="bg-gray-200 text-black py-8 px-4 font-rajdhani mt-auto">
      <div className="container mx-auto">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            <h2 className="text-xl font-bold mb-4">Syntesol</h2>
          ...
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            ...
            <div className="flex space-x-4">
              <Link href="https://facebook.com" passHref legacyBehavior target="_blank" rel="noopener noreferrer">
                <FaFacebookF className="text-black hover:text-blue-600" />
              </Link>
              ...
              <Link href="https://instagram.com" passHref legacyBehavior target="_blank" rel="noopener noreferrer">
                <FaInstagram className="text-black hover:text-pink-600" />
              </Link>
              <Link href="https://linkedin.com" passHref legacyBehavior target="_blank" rel="noopener noreferrer">
                <FaLinkedinIn className="text-black hover:text-blue-700" />
              </Link>
            </div>
          </div>
